...
temp <- "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/files/samples/"
...
one_gram <- tokens(myCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 1L)
ns_one_gram <- tokens_remove(one_gram, stopwords("english"))
dfm_one_gram_stem_and_stop <- dfm(ns_one_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_one_gram_stem_and_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_one_gram_stem_and_stop.rds")
...
write_csv(one_gram_s_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/one_gram_s_s.csv")
...
```{r no stemming but stopping}
dfm_one_gram_nostem_and_stop <- dfm(ns_one_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_one_gram_nostem_and_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_one_gram_nostem_and_stop.rds")
...
write_csv(one_gram_ns_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/one_gram_ns_s.csv")
rm(one_gram_ns_s)
rm(dfm_one_gram_nostem_and_stop)
```
## onegram with stemming on no stopwords
``` {r onegram with stemming on no stopwords}
dfm_one_gram_stem_and_nostop <- dfm(one_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_one_gram_stem_and_nostop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_one_gram_stem_and_nostop.rds")
...
write_csv(one_gram_s_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/one_gram_s_ns.csv")
rm(one_gram_s_ns)
rm(dfm_one_gram_stem_and_nostop)
```
## no stemming or stopwords

``` {r no stemming or stopwords}
dfm_one_gram_nostem_and_nostop <- dfm(one_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_one_gram_nostem_and_nostop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_one_gram_nostem_and_nostop.rds")
...
write_csv(one_gram_ns_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/one_gram_ns_ns.csv")
rm(one_gram_ns_ns)
...
``` {r bigrams with stemming and stop words removed}
##bigrams with stemming and stop words removed
bi_gram <- tokens(myCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 2L, concatenator = " ")
ns_bi_gram <- tokens(ns_one_gram, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 2L, concatenator = " ")
dfm_bi_gram_stem_stop <- dfm(ns_bi_gram, tolower = TRUE, stem = TRUE, remove = stopwords("english"))
####saveRDS(dfm_bi_gram_stem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_bi_gram_stem_stop.rds")
...
write_csv(bi_gram_s_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/bi_gram_s_s.csv")
rm(dfm_bi_gram_stem_stop)
rm(bi_gram_s_s)
```
##bigrams with no stemming but stopwords
```{r bigrams with no stemming but stopwords}
dfm_bi_gram_nostem_stop <- dfm(ns_bi_gram, tolower = TRUE, stem = FALSE, remove = stopwords("english"))
####saveRDS(dfm_bi_gram_nostem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_bi_gram_nostem_stop.rds")
...
write_csv(bi_gram_ns_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/bi_gram_ns_s.csv")
rm(dfm_bi_gram_nostem_stop)
rm(bi_gram_ns_s)
rm(ns_bi_gram)
```
## stemming, but no stopwords
```{r bigrams with stemming but no stopwords}
dfm_bi_gram_stem_nostop <- dfm(bi_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_bi_gram_stem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_bi_gram_stem_nostop.rds")
...
write_csv(bi_gram_s_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/bi_gram_s_ns.csv")
rm(dfm_bi_gram_nostem_stop)
rm(bi_gram_s_ns)
```
...
``` {r bigrams with neither stemming nor stop words}
dfm_bi_gram_nostem_nostop <- dfm(bi_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_bi_gram_nostem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_bi_gram_stem_nostop.rds")
...
write_csv(bi_gram_ns_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/bi_gram_ns_ns.csv")
...
``` {r trigrams with stemming and stop words removed}
##trigrams with stemming and stop words removed
tri_gram <- tokens(myCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 3L,concatenator = " ")
ns_tri_gram <- tokens(ns_one_gram, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 3L, concatenator = " ")
dfm_tri_gram_stem_stop <- dfm(ns_tri_gram, tolower = TRUE, stem = TRUE, remove = stopwords("english"))
##saveRDS(dfm_tri_gram_stem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_tri_gram_stem_stop.rds")
...
write_csv(tri_gram_s_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/tri_gram_s_s.csv")
rm(dfm_tri_gram_stem)
rm(tri_gram_s_s)
```
##trigrams with no stemming but stopwords
```{r trigrams with no stemming but stopwords}
dfm_tri_gram_nostem_stop <- dfm(ns_tri_gram, tolower = TRUE, stem = FALSE, remove = stopwords("english"))
##saveRDS(dfm_tri_gram_nostem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_tri_gram_nostem_stop.rds")
...
write_csv(tri_gram_ns_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/tri_gram_ns_s.csv")
rm(dfm_tri_gram_nostem_stop)
rm(tri_gram_ns_s)
rm(ns_tri_gram)
```
## stemming, but no stopwords
```{r trigrams with stemming but no stopwords}
dfm_tri_gram_stem_nostop <- dfm(tri_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_tri_gram_stem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_tri_gram_stem_nostop.rds")
...
write_csv(tri_gram_s_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/tri_gram_s_ns.csv")
rm(dfm_tri_gram_nostem_stop)
rm(tri_gram_s_ns)
```
...
``` {r tri neither stemming nor stop words}
dfm_tri_gram_nostem_nostop <- dfm(tri_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_tri_gram_nostem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_tri_gram_stem_nostop.rds")
...
write_csv(tri_gram_ns_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/tri_gram_ns_ns.csv")
...
```{r quadgrams with stemming and stop words removed}
##quadgrams with stemming and stop words removed
quad_gram <- tokens(myCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 4L, concatenator = " ")
ns_quad_gram <- tokens(ns_one_gram, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 4L, concatenator = " ")
dfm_quad_gram_stem_stop <- dfm(ns_quad_gram, tolower = TRUE, stem = TRUE, remove = stopwords("english"))
##saveRDS(dfm_quad_gram_stem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quad_gram_stem_stop.rds")
...
write_csv(quad_gram_s_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quad_gram_s_s.csv")
rm(dfm_quad_gram_stem)
rm(quad_gram_s_s)
```
##quadgrams with no stemming but stopwords
```{r quadgrams with no stemming but stopwords}
dfm_quad_gram_nostem_stop <- dfm(ns_quad_gram, tolower = TRUE, stem = FALSE, remove = stopwords("english"))
##saveRDS(dfm_quad_gram_nostem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quad_gram_nostem_stop.rds")
...
write_csv(quad_gram_ns_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quad_gram_ns_s.csv")
rm(dfm_quad_gram_nostem_stop)
rm(quad_gram_ns_s)
rm(ns_quad_gram)
```
## stemming, but no stopwords
```{r quadgrams with stemming but no stopwords}
dfm_quad_gram_stem_nostop <- dfm(quad_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_quad_gram_stem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quad_gram_stem_nostop.rds")
...
write_csv(quad_gram_s_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quad_gram_s_ns.csv")
rm(dfm_quad_gram_nostem_stop)
rm(quad_gram_s_ns)
```
...
``` {r quadgrams with neither stemming nor stop words}
dfm_quad_gram_nostem_nostop <- dfm(quad_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_quad_gram_nostem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quad_gram_stem_nostop.rds")
...
write_csv(quad_gram_ns_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quad_gram_ns_ns.csv")
...
```{r quingrams with stemming and stop words removed}
##quingrams with stemming and stop words removed
quin_gram <- tokens(myCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 5L,concatenator = " ")
ns_quin_gram <- tokens(ns_one_gram, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 5L, concatenator = " ")
dfm_quin_gram_stem_stop <- dfm(ns_quin_gram, tolower = TRUE, stem = TRUE, remove = stopwords("english"))
##saveRDS(dfm_quin_gram_stem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quin_gram_stem_stop.rds")
...
write_csv(quin_gram_s_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quin_gram_s_s.csv")
rm(dfm_quin_gram_stem)
rm(quin_gram_s_s)
```
##quingrams with no stemming but stopwords
```{r quingrams with no stemming but stopwords}
dfm_quin_gram_nostem_stop <- dfm(ns_quin_gram, tolower = TRUE, stem = FALSE, remove = stopwords("english"))
##saveRDS(dfm_quin_gram_nostem_stop, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quin_gram_nostem_stop.rds")
...
write_csv(quin_gram_ns_s, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quin_gram_ns_s.csv")
rm(dfm_quin_gram_nostem_stop)
rm(quin_gram_ns_s)
rm(ns_quin_gram)
```
## stemming, but no stopwords
```{r quingrams with stemming but no stopwords}
dfm_quin_gram_stem_nostop <- dfm(quin_gram, tolower = TRUE, stem = TRUE)
##saveRDS(dfm_quin_gram_stem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quin_gram_stem_nostop.rds")
...
write_csv(quin_gram_s_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quin_gram_s_ns.csv")
...
``` {r quingrams with neither stemming nor stop words}
dfm_quin_gram_nostem_nostop <- dfm(quin_gram, tolower = TRUE, stem = FALSE)
##saveRDS(dfm_quin_gram_nostem_nostop , "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/dfm_quin_gram_stem_nostop.rds")
...
write_csv(quin_gram_ns_ns, "/Users/mutecypher/Documents/Documents - Michael’s iMac/Coursera/Capstone Project/20sample/quin_gram_ns_ns.csv")
