...
```{r try}
eng_news <- read_file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.news.txt")
nchar(eng_news)
```
...
```{r next one}
eng_blogs <- read_file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.blogs.txt")
nchar(eng_blogs)
```
...
```{r next read}
eng_twitter <- read_file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.twitter.txt")
nchar(eng_twitter)
blog_us <- file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.blogs.txt")
tweet_us <- file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.twitter.txt")
news_us <- file("C:/Users/mpearson/OneDrive - Forest Ridge School of the Sacred Heart/files/en_US/en_US.news.txt")
newslines <- countLines("C:\Users\mpearson\OneDrive - Forest Ridge School of the Sacred Heart\files\en_US\en_US.news.txt")
bloglines <- countLines("C:\Users\mpearson\OneDrive - Forest Ridge School of the Sacred Heart\files\en_US\en_US.blogs.txt")
tweetlines <- countLines("C:\Users\mpearson\OneDrive - Forest Ridge School of the Sacred Heart\files\en_USen_US.twitter.txt")
...
```{r get it in}
bwlines <- countLines("C:\Users\mpearson\OneDrive - Forest Ridge School of the Sacred Heart\files\full-list-of-bad-words-banned-by-google-txt-file_2013_11_26_04_53_31_867.txt")
badwords <- readLines("C:\Users\mpearson\OneDrive - Forest Ridge School of the Sacred Heart\files\full-list-of-bad-words-banned-by-google-txt-file_2013_11_26_04_53_31_867.txt", n= bwlines, warn = FALSE, encoding = "latin1", skipNul = FALSE)
set.seed(1151960)
samp_per <- 0.2
