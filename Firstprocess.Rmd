...
test_one_gram <- tokens(testCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 1L)
...
```{r no stemming but stopping, eval= FALSE}
...
``` {r onegram with stemming on no stopwords, eval = FALSE}
...
``` {r bigrams with stemming and stop words removed, eval = FALSE}
...
```{r bigrams with no stemming but stopwords, eval = FALSE}
...
```{r bigrams with stemming but no stopwords, eval = FALSE}
...
bi_gram <- tokens(testCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 2L, concatenator = " ")
dfm_bi_gram_nostem_nostop <- dfm(bi_gram, tolower = TRUE, stem = FALSE)
bi_gram_ns_ns <- sort(colSums(dfm_bi_gram_nostem_nostop), decreasing = TRUE)
bi_gram_ns_ns <- data.frame(bi_gram_ns_ns)
bi_gram_ns_ns <- setDT(bi_gram_ns_ns, keep.rownames = TRUE)
...
``` {r trigrams with stemming and stop words removed, eval = FALSE}
...
```{r trigrams with no stemming but stopwords, eval = FALSE}
...
```
## stemming, but no stopwords
```{r trigrams with stemming but no stopwords, eval = FALSE}
...
tri_gram <- tokens(testCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 3L,concatenator = " ")
dfm_tri_gram_nostem_nostop <- dfm(tri_gram, tolower = TRUE, stem = FALSE)
tri_gram_ns_ns <- sort(colSums(dfm_tri_gram_nostem_nostop), decreasing = TRUE)
tri_gram_ns_ns <- data.frame(tri_gram_ns_ns)
tri_gram_ns_ns <- setDT(tri_gram_ns_ns, keep.rownames = TRUE)
...
```{r quadgrams with stemming and stop words removed, eval = FALSE}
...
```{r quadgrams with no stemming but stopwords, eval = FALSE}
...
```
## stemming, but no stopwords
```{r quadgrams with stemming but no stopwords, eval = FALSE}
...
quad_gram <- tokens(testCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 4L, concatenator = " ")
dfm_quad_gram_nostem_nostop <- dfm(quad_gram, tolower = TRUE, stem = FALSE)
quad_gram_ns_ns <- sort(colSums(dfm_quad_gram_nostem_nostop), decreasing = TRUE)
quad_gram_ns_ns <- data.frame(quad_gram_ns_ns)
quad_gram_ns_ns <- setDT(quad_gram_ns_ns, keep.rownames = TRUE)
...
```{r quingrams with stemming and stop words removed, eval = FALSE}
...
```{r quingrams with no stemming but stopwords, eval = FALSE}
...
```
## stemming, but no stopwords
```{r quingrams with stemming but no stopwords, eval = FALSE}
...
quin_gram <- tokens(testCorpus, what = c("word"), remove_numbers = TRUE, remove_punct = TRUE, remove_symbols = TRUE, remove_twitter = TRUE, remove_hyphens = TRUE, remove_url = TRUE, ngrams = 5L,concatenator = " ")
dfm_quin_gram_nostem_nostop <- dfm(quin_gram, tolower = TRUE, stem = FALSE)
quin_gram_ns_ns <- sort(colSums(dfm_quin_gram_nostem_nostop), decreasing = TRUE)
quin_gram_ns_ns <- data.frame(quin_gram_ns_ns)
quin_gram_ns_ns <- setDT(quin_gram_ns_ns, keep.rownames = TRUE)
