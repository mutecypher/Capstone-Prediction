...
data("stop_words")
text_tokens <- sam_tidy %>% unnest_tokens(word, text) %>% anti_join(stop_words, by = "word")
...
quin_quingram <-  separate(quingram_count, quingram, c("word1", "word2", "word3", "word4", "word5"), sep = " ")
```
